...
// Volta da tela de resumo para a tela de votação, zerando o contador
// e já carregando um filme novo (a rodada anterior já foi concluída)
function voltarAVotar() {
  totalVotos = 0;
  elContador.textContent = "votos 0 / 10";
...
btnVoltar.addEventListener("click", voltarAVotar);
